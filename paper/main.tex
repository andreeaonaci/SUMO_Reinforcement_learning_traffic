...
the range is given. Movement coverage is the fraction of movements possessing a
downstream lane inside the modelled area, used in Section~\ref{sec:results}-E.}
\label{tab:networks}
\centering\footnotesize
\begin{tabular}{@{}llrrr@{}}
\toprule
Network & Role & Signals & $A$ & Coverage \\
\midrule
\texttt{arterial4x4} & train & $16$ & $5$ & $75\%$ \\
\texttt{cologne3} & train & $3$ & $3$--$4$ & $33\%$ \\
\texttt{ingolstadt7} & train & $7$ & $2$--$3$ & $39\%$ \\
\texttt{grid4x4} & \textbf{holdout} & $16$ & $8$ & $75\%$ \\
\midrule
$4$-phase grid & control holdout & $9$ & $4$ & --- \\
\texttt{grid4x4}, $3\times$ demand & stress holdout & $16$ & $8$ & $75\%$ \\
\bottomrule
\end{tabular}
\end{table}
...
Yellow interval & $3$\,s (benchmark-matched) \\
