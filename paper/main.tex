...
$2856$ vehicles depart inside the evaluation window; \emph{completed} is
arrived/departed. Delay and trip time are means over arrived vehicles only, so
they must be read together with that column. The benchmark does not report
...
\begin{tabular}{@{}lrrrr@{}}
\toprule
Controller & Delay (s) & Trip (s) & Arrived & Completed \\
\midrule
C. FRAP ($5$-round ckpt.) & $150.3$ & $188.0$ & $2411$ & $84.4\%$ \\
A. Indexed & $54.0$ & $91.2$ & $2217$ & $77.6\%$ \\
Fixed time & $34.6$ & $72.4$ & $2810$ & $98.4\%$ \\
Max pressure & $22.4$ & $60.1$ & $2817$ & $\mathbf{98.6\%}$ \\
\textbf{B. Phase-relational} & $\mathbf{21.4}$ & $\mathbf{58.9}$ & $2615$ & $91.6\%$ \\
\midrule
...
\begin{table}[h]
\caption{\texttt{ingolstadt7}, in-distribution, six seeds. $3031$ vehicles depart
inside the evaluation window. The proposed readout attains the highest completion
...
Controller & Delay (s) & Trip (s) & Arrived & Completed \\
\midrule
C. FRAP ($5$-round ckpt.) & $93.4$ & $137.3$ & $2690$ & $88.7\%$ \\
Fixed time & $92.2$ & $136.2$ & $2833$ & $93.5\%$ \\
A. Indexed & $84.7$ & $128.0$ & $2433$ & $80.3\%$ \\
\textbf{B. Phase-relational} & $35.2$ & $79.0$ & $\mathbf{2891}$ & $\mathbf{95.4\%}$ \\
Max pressure & $\mathbf{26.6}$ & $\mathbf{71.5}$ & $2681$ & $88.5\%$ \\
\midrule
